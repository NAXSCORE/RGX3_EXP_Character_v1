...
NOTE: I now suggest you add an AutoRigHand component to the hand and use it to try to automatically find and set up the fingers, alternatively follow steps 7-9 to do it manually.
