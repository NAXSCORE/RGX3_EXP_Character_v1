Shader "Ethical Motion/Particles/Unity5/Lit Alpha Erosion Emissive" {
	Properties {
	...
	SubShader {
		...
		CGPROGRAM
		#pragma surface surf SmokeSelfIlluminated noforwardadd addshadow alpha:fade nodynlightmap nodirlightmap 
		#pragma target 3.0
