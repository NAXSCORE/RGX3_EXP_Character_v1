Shader "Ethical Motion/Particles/Unity5/Lit Alpha Erosion Soft Particle" {
	Properties {
	...
	SubShader {
		...
		CGPROGRAM
		#pragma surface surf Smoke vertex:vert noforwardadd addshadow alpha:fade nodynlightmap nodirlightmap 
		#pragma target 3.0
